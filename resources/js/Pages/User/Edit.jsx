...
export default function Edit({ auth, user_types, window_list, user_edit }) {
    const { data, setData, post, errors, reset } = useForm({
        name: user_edit.data.name || "",
        email: user_edit.data.email || "",
        user_type_id: user_edit.data.user_type_id || "",
        window_id: user_edit.data.window_id || "",
        window_num: user_edit.data.window_num || "",
        _method: "PUT",
    });
    ...
    const handleSubmit = (e) => {
        ...
        post(route("users.update", user_edit.data.id));
    };
